...
get_date_time_from_timezone("New York", "America/New_York")
get_date_time_from_timezone("Dubai", "Asia/Dubai")
get_date_time_from_timezone("Monterrey", "America/Monterrey")